  ...
  const renderOverview = () => (
    <div className="space-y-8 ">
      ...
      <div className="text-center">
        <div className="flex items-center justify-center w-16 h-16 bg-linear-to-r from-blue-600 to-purple-600 rounded-full mx-auto mb-4">
              ...
              {filteredSections.map((section) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div
                      className={`p-3 bg-linear-to-r ${section.color} rounded-lg text-white group-hover:scale-110 transition-transform duration-200`}
                    >
                      {section.icon}
                    </div>
