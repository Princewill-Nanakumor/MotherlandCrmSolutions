...
describe("HolidayEffectsOverlay", () => {
  ...
  it("renders valentine effect when active", async () => {
    ...
    expect(
      await screen.findByTestId("holiday-effect-cupid-arrow"),
    ).toBeInTheDocument();
  });
  ...
  it("renders christmas snow when active", async () => {
    ...
    expect(
      await screen.findByTestId("holiday-effect-christmas"),
    ).toBeInTheDocument();
  });
  ...
  it("renders new year fireworks when active", async () => {
    ...
    expect(
      await screen.findByTestId("holiday-effect-new-year"),
    ).toBeInTheDocument();
  });
  ...
  it("renders halloween bats when active", async () => {
    ...
    expect(
      await screen.findByTestId("holiday-effect-halloween"),
    ).toBeInTheDocument();
  });
