      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={onClose}
              className="text-2xl font-bold text-gray-400 transition-colors hover:text-gray-600 dark:text-gray-300 dark:hover:text-gray-100"
            >
              <X className="w-6 h-6" />
            </button>
          </div>
          ...
          {/* General Error */}
          {generalError && (
            <div className="p-3 mb-4 border border-red-200 rounded-md bg-red-50 dark:bg-red-900/20 dark:border-red-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end pt-4 space-x-3">
              ...
              <button
                ...
                className="px-4 py-2 font-semibold text-white transition-colors rounded-md bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-0 focus:border-(--brand-focus) disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading
                  ? "Creating..."
                  : mode === "create"
