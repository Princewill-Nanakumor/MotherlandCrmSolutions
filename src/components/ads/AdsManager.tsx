  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-xl p-8 mx-auto mt-16 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
      <div className="flex flex-col items-center mb-6">
        <div className="p-4 mb-4 rounded-full brand-soft-bg">
          <Megaphone className="w-10 h-10 brand-icon" />
        </div>
        ...
        <span className="inline-block px-4 py-2 text-sm font-semibold rounded-full brand-chip">
          Stay tuned 🚀
        </span>
      </div>
    </div>
